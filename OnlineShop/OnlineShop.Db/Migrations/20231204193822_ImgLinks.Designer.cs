...
namespace OnlineShop.Db.Migrations
{
    ...
    [Migration("20231204193822_ImgLinks")]
    partial class ImgLinks
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OnlineShop.Db.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1f4fcca5-1115-4d69-a437-dfa20887a6de"),
                            Cost = 79990m,
                        ...
                        new
                        {
                            Id = new Guid("f1dd9bda-7cd8-42f8-a138-efa0757e4ffe"),
                            Cost = 95990m,
                        ...
                        new
                        {
                            Id = new Guid("289e53f5-d177-4f51-948f-b66869bf5f62"),
                            Cost = 84990m,
                        ...
                        new
                        {
                            Id = new Guid("22b450e8-d39c-4593-b701-fa87467663d6"),
                            Cost = 94990m,
            ...
            modelBuilder.Entity("OnlineShop.Db.Models.Сharacteristics", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("dda640ea-b5e9-487c-98ce-fc86b2e7a5c9"),
                            Color = "Красный",
                            Polyphony = "192",
                            Power = "16",
                            ProductId = new Guid("1f4fcca5-1115-4d69-a437-dfa20887a6de"),
                            Timbers = "18"
                        },
                        new
                        {
                            Id = new Guid("dfd1377e-0784-430a-81a5-8b07058843a7"),
                            Color = "Чёрный",
                            Polyphony = "128",
                            Power = "14",
                            ProductId = new Guid("f1dd9bda-7cd8-42f8-a138-efa0757e4ffe"),
                            Timbers = "600"
                        },
                        new
                        {
                            Id = new Guid("f09607f2-a533-4fc1-a96f-331a3b980780"),
                            Color = "Белый",
                            Polyphony = "256",
                            Power = "56",
                            ProductId = new Guid("289e53f5-d177-4f51-948f-b66869bf5f62"),
                            Timbers = "22"
                        },
                        new
                        {
                            Id = new Guid("20fc8f8d-3070-4704-82b4-02a34d78c3ef"),
                            Color = "Чёрный",
                            Polyphony = "192",
                            Power = "14",
                            ProductId = new Guid("22b450e8-d39c-4593-b701-fa87467663d6"),
                            Timbers = "24"
                        });
                });
