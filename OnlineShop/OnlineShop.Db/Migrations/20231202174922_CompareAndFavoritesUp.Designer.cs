...
namespace OnlineShop.Db.Migrations
{
    ...
    [Migration("20231202174922_CompareAndFavoritesUp")]
    partial class CompareAndFavoritesUp
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OnlineShop.Db.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("aab6b6e7-a6ca-4863-8c17-31f115bd9407"),
                            Cost = 79990m,
                        ...
                        new
                        {
                            Id = new Guid("205db977-4475-4f29-8ad1-cdb02925d755"),
                            Cost = 95990m,
                        ...
                        new
                        {
                            Id = new Guid("53713e75-ed51-4c0a-8fa4-1b7fc7a90c7f"),
                            Cost = 84990m,
                        ...
                        new
                        {
                            Id = new Guid("f0cf9cc4-4fa4-4078-8349-92df11b577f8"),
                            Cost = 94990m,
            ...
            modelBuilder.Entity("OnlineShop.Db.Models.Сharacteristics", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b1091c03-2ac3-4f45-9b63-c78256225243"),
                            Color = "Красный",
                            Polyphony = "192",
                            Power = "16",
                            ProductId = new Guid("aab6b6e7-a6ca-4863-8c17-31f115bd9407"),
                            Timbers = "18"
                        },
                        new
                        {
                            Id = new Guid("fa08acca-387b-4bc9-aed2-e84d44b32099"),
                            Color = "Чёрный",
                            Polyphony = "128",
                            Power = "14",
                            ProductId = new Guid("205db977-4475-4f29-8ad1-cdb02925d755"),
                            Timbers = "600"
                        },
                        new
                        {
                            Id = new Guid("b9a7def3-0cb6-4970-aec3-a81e8b36deda"),
                            Color = "Белый",
                            Polyphony = "256",
                            Power = "56",
                            ProductId = new Guid("53713e75-ed51-4c0a-8fa4-1b7fc7a90c7f"),
                            Timbers = "22"
                        },
                        new
                        {
                            Id = new Guid("7ca43d39-7cc4-4a62-afac-3fcb574da79c"),
                            Color = "Чёрный",
                            Polyphony = "192",
                            Power = "14",
                            ProductId = new Guid("f0cf9cc4-4fa4-4078-8349-92df11b577f8"),
                            Timbers = "24"
                        });
                });
